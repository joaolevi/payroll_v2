...
class MainMenu():
    ...
    def employee_remove(self):
        ...
        self.HumanResourcers.remove_employee_hr(emp_id)
        self.Finances.remove_employee_fin(emp_id)
        self.Administration.remove_employee_adm(emp_id)
    ...
    def set_tax_to_emp(self):
        ...
        self.Finances.setTaxToEmployee(tax_value)
